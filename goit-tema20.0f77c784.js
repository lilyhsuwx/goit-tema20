...
galeryEl.addEventListener("click", (e)=>{
  ...
  `);
    instance.show();
    if (instance) document.addEventListener("keydown", closeModal);
});
if (!instance) document.removeEventListener("keydown", closeModal);
...
},{}],"lf3c2":[function() {},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequirec6c7", {})
